// This contains an integration test that uploads the fixtures dir to web3.storage or Moralis
...
test("pickName", (t) => {
  const name = pickName({
    repo: "good/one",
    run: "101",
    sha: "6a8a00320d3e15207b1c8b161471e5ba78e464e1",
  });
...
test("runs like an action", (t) => {
  ...
  t.is(
    output,
    `Adding test/fixtures to https://api-staging.web3.storage
